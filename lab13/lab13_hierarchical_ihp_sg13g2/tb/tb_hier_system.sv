...
module tb_hier_system;
    ...
    task automatic expect(input logic [7:0] expected, input string label);
        #1;
    ...
    initial begin
        ...
        select_i = 1'b0;
        expect(8'h05, "counter counts five cycles");
        ...
        accum_enable_i = 1'b0;
        select_i = 1'b1;
        expect(8'h0c, "accumulator adds four times");

        @(negedge clk_i);
        rst_ni = 1'b0;
        #1;
        select_i = 1'b0;
        expect(8'h00, "counter asynchronous reset");
        select_i = 1'b1;
        expect(8'h00, "accumulator asynchronous reset");
